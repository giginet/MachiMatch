...
class Navigation(Image):
    ...
    def __init__(self, owner):
        ...
        self.label.x = self.x + self.LABEL_POSITIONS[number][0]
        self.label.y = self.y + self.LABEL_POSITIONS[number][1]
        self.population = PopulationCounter(owner)
        self.population.x = self.label.x + self.POPULATION_POSITIONS[number][0]
        self.population.y = self.label.y + self.POPULATION_POSITIONS[number][1]
